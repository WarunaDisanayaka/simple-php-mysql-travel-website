...
<html>
    ...
    .itinary2bg-image {
        /* The image used */
        background-image: url("https://i.pinimg.com/564x/a4/0d/16/a40d1627468d82a22179e3f0aa5f210e.jpg");
...
.itinary03 .card .card-body{
    background: transparent;
}
.itinary03 .card .card-body h3{
    font-size: 25px;
    font-weight: 600;
}
.itinary03 .card .card-body p{
  font-weight: 500;
}
    ...
    <body>
       ...
       <div class="bg-text">
         <h4>3 days</h4>
         <h1 style="font-size:50px">Three Days Itinaries</h1>
       </div>
       <!-- end of blured image-->
       ...
       <section class="itinary03" id="itinary03">
        ...
        <div class="container">
            ...
            <div class="row" style="margin-top: 30px;">
              ...
              <div class="col-md-4 py-3 py-md-0">
                <div class="card">
                  ...
                  <h3>Three Days Tour 01</h3>
                  <div class="container text-center">
                    <p>Anuradhapura > Minneriya > Sigiriya > Dambulla</p>
                </div>
            </div>
          </div>
          ...
          <div class="col-md-4 py-3 py-md-0">
            <div class="card">
              <img src="https://www.hotelmanagement-network.com/wp-content/uploads/sites/25/2022/08/shutterstock_1046627314.jpg" alt="">
              <h3>Three Days Tour 02</h3>
              <div class="container text-center">
                <p>Sigiriya > Minneriya > Dambulla > Kandy > Kitulgala</p>
            </div>
        </div>
      </div>
      ...
      <div class="col-md-4 py-3 py-md-0">
        <div class="card">
          <img src="https://cdn.getyourguide.com/img/tour/0504d78e8c87fa84.jpeg/145.jpg" alt="">
          <h3>Three Days Tour 03</h3>
          <div class="container text-center">
            <p>Galle > Yala > Ella > Nuwara Eliya > Kitulgala</p>
        </div>
    </div>
  </div>
        ...
        <div class="row" style="margin-top: 30px;">
          ...
          <div class="col-md-4 py-3 py-md-0">
            <div class="card">
              ...
              <h3>Three Days Tour 04</h3>
              <div class="container text-center">
                <p>Galle > Mirissa > Udawalawe > Rathnapura</p>
            </div>
        </div>
      </div>
      ...
      <div class="col-md-4 py-3 py-md-0">
        <div class="card">
          ...
          <h3>Three Days Tour 05</h3>
          <div class="container text-center">
            <p>Pinnawala > Kandy > Nuwara Eliya > Kitulgala</p>
        </div>
    </div>
  </div>
  ...
  <div class="col-md-4 py-3 py-md-0">
    ...
    <div class="form">
      <form action="/action_page.php">
        ...
        <select name="Daythree" id="Daythree">
